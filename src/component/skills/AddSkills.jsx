        ...
        <section class="w-full">
            <nav class="flex border-b-2" aria-label="Breadcrumb">
                <ol class="p-3 px-6 inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">/<a href="#" class="ms-1 text-md font-medium text-gray-700 hover:text-blue-600 md:ms-2">Skill</a></div>
                    </li>
                    ...
                    <form
                        ...
                        <div className='flex gap-8 flex-wrap'>
                            <div className='basis-[50%]'>
                                ...
                                <div class="mb-5">
                                    <label for="base-input" class="block mb-5 	text-base font-medium text-gray-900">percentage</label>
                                    <input
                                        name="percentage"
                                        type="text"
             ...
             0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"
              ...
              0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"
                        ...
                        <div className="mb-5">
                            ...
                            >
                                <option selected={
                                        (skilldetail.type === 'tech')
                                            ? 'selected' : ''
                                    }  value="tech">Technology</option>
                                <option selected={
                                        (skilldetail.type === 'skill')
                                            ? 'selected' : ''
